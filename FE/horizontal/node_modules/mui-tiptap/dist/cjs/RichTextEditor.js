...
const RichTextEditor = (0, react_2.forwardRef)(function RichTextEditor(_a, ref) {
    ...
    editable = true } = _a, editorOptions = __rest(_a, ["className", "renderControls", "RichTextFieldProps", "children", "editorDependencies", "editable"]);
    const editor = (0, react_1.useEditor)(Object.assign({ editable: editable }, editorOptions), editorDependencies);
