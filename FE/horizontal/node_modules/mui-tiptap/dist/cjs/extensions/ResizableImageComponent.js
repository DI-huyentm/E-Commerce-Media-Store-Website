...
function ResizableImageComponent(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_1.NodeViewWrapper, { style: {
        ...
        as: extension.options.inline ? "span" : "div", children: (0, jsx_runtime_1.jsxs)("div", { className: classes.imageContainer, children: [(0, jsx_runtime_1.jsx)("img", { ref: imageRef, src: attrs.src, height: "auto", width: attrs.width ? attrs.width : undefined, 
