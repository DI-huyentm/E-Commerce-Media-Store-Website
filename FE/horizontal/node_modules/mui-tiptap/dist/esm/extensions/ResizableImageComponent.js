...
function ResizableImageComponent(props) {
    ...
    return (_jsx(NodeViewWrapper, { style: {
        ...
        as: extension.options.inline ? "span" : "div", children: _jsxs("div", { className: classes.imageContainer, children: [_jsx("img", { ref: imageRef, src: attrs.src, height: "auto", width: attrs.width ? attrs.width : undefined, 
